...
public interface AuthAPI {
  ...
  @Operation(summary = "소상공인 회원가입", description = """
      이메일 인증이 완료된 사용자의 계정과 가게 정보를 등록합니다.

      회원가입 시 가게 지역 정보(region)는 필수입니다.
      region은 프론트엔드에서 카카오맵을 통해 받은 지역 정보를 문자열로 전달합니다.
      ...
      region이 누락되거나 허용되지 않은 값이면 회원가입이 실패합니다.
      """)
  @ApiResponses({
