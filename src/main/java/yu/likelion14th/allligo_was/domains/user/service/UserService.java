...
public class UserService {
        ...
        @Transactional
        public UserMypageResDto updateProfileImage(Long userId, UserProfileImageUpdateReqDto dto) {
                User user = userRepository.findById(userId)
                                .orElseThrow(() -> new CustomException(ErrorCode.USER_NOT_FOUND));
                ...
                s3Service.validateFileUrl(userId, UploadDomain.PROFILE, dto.getProfileImageUrl());

                store.updateProfileImage(dto.getProfileImageUrl());
